...
features = {
 "ResNet-50": ("./features/train/features_resnet50train_norm.npy", "./features/val/features_resnet50val_norm.npy"),
 "UNI2-h": ("./features/train/features_uni2train_norm.npy", "./features/val/features_uni2val_norm.npy"),
 "Prov-GigaPath": ("./features/train/features_gigapathtrain_norm.npy", "./features/val/features_gigapathval_norm.npy"),
 "Virchow2": ("./features/train/features_virchow2train_norm.npy", "./features/val/features_virchow2val_norm.npy"),
 "PLIP": ("./features/train/features_pliptrain_norm.npy", "./features/val/features_plipval_norm.npy"),
 "DINOv3": ("./features/train/features_dinov3train_norm.npy", "./features/val/features_dinov3val_norm.npy"),
 "CONCH": ("./features/train/features_conchtrain_norm.npy", "./features/val/features_conchval_norm.npy"),
 "Phikon2": ("./features/train/features_phikon2train_norm.npy", "./features/val/features_phikon2val_norm.npy")
}
...
for name_feature, (train_file, val_file) in features.items():
   ...
   joblib.dump(scaler, f"./trained_models/scaler_{name_feature}_norm.joblib")
   ...
   for name_classifier, classifier in classifiers.items():
      ...
      if name_classifier=="Red Propia":
         ...
         joblib.dump(classifier, f"./trained_models/{name_classifier}_{name_feature}_norm.joblib")
...
output="SICAPV2_trained_classifiers_norm.xlsx"
