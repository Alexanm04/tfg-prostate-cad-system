...
if  model_selected == "resnet50":
   ...
   output = "./features/val/features_resnet50val.npy"
   ...
   transformation = transforms.Compose([ transforms.Resize(224),
      transforms.ToTensor(), 
      transforms.Normalize(mean=[0.485,0.456,0.406], std=[0.229,0.224,0.225])])
   output = "./features/val/features_uni2val.npy"
   ...
   output = "./features/val/features_gigapathval.npy"
   ...
   output = "./features/val/features_conchval.npy"
   ...
   output = "./features/val/features_virchow2val.npy"

elif model_selected == "phikon2":
   processor = AutoImageProcessor.from_pretrained("owkin/phikon-v2")
   model = AutoModel.from_pretrained("owkin/phikon-v2")
   transformation = processor
   output = "./features/val/features_phikon2val.npy"

elif model_selected == "plip":
   processor = CLIPProcessor.from_pretrained("vinid/plip")
   model = CLIPModel.from_pretrained("vinid/plip")
   transformation = processor
   output = "./features/val/features_plipval.npy"
   ...
   transformation = processor
   output = "./features/val/features_dinov3val.npy"
