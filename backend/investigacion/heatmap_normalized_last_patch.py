...
output = f"Normalized_heatmap_{slide}_{features_extractor}_{model_classifier}_Original.jpg"
...
output = f"Normalized_heatmap_{slide}_{features_extractor}_{model_classifier}_GroundTruth.jpg"
...
output = f"Normalized_heatmap_{slide}_{features_extractor}_{model_classifier}_Prediction.jpg"
